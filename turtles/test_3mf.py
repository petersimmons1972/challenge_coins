#!/usr/bin/env python3
"""
TDD tests for the Turtles Challenge Coin 3MF builder.

Verifies Bambu Studio-native 3MF structure and Turtles-specific colors.
"""
import json
import os
import sys
...
class TestExtruderAssignments(unittest.TestCase):
    ...
    def test_each_color_has_correct_extruder(self):
        ...
        self.assertEqual(assignments["Gold"], 2)
        self.assertEqual(assignments["Green"], 3)
...
class TestFilamentColors(unittest.TestCase):
    ...
    def test_gold_is_slot_2(self):
        self.assertEqual(self.config["filament_colour"][1], "#D4AF37")

    def test_green_is_slot_3(self):
        self.assertEqual(self.config["filament_colour"][2], "#2D6A4F")
