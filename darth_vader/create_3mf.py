#!/usr/bin/env python3
"""
Package Darth Vader Challenge Coin STLs into a Bambu Studio-native 3MF.

Colors / AMS Slots:
  1: Black          (#1A1A1A) — rim, Vader helmet (obverse)
  2: Starbucks Gold (#CBA258) — accent ring
  3: Starbucks Green (#00704A) — inner field
...
COIN = {
    "name": "Darth Vader Challenge Coin",
    "output": "Darth_Vader_Challenge_Coin.3mf",
    "colors": [
...
<model unit="millimeter" xml:lang="en-US" xmlns="http://schemas.microsoft.com/3dmanufacturing/core/2015/02" xmlns:BambuStudio="http://schemas.bambulab.com/package/2021" xmlns:p="http://schemas.microsoft.com/3dmanufacturing/production/2015/06" requiredextensions="p">
 ...
 <metadata name="BambuStudio:3mfVersion">1</metadata>
 <metadata name="Title">Darth Vader Challenge Coin</metadata>
 <resources>
...
<config>
  <object id="{assembly_id}">
    <metadata key="name" value="Darth Vader Challenge Coin"/>
...
def main():
    ...
    print("=== Packaging Darth Vader Challenge Coin ===")
    print()
    print(f"--- {COIN['name']} ---")
