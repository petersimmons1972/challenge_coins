#!/usr/bin/env python3
"""
Package Chattahoochee Gold Swimming Challenge Coin STLs into a Bambu Studio-native 3MF.
...
COIN = {
    "name": "Chattahoochee Gold Challenge Coin",
    "output": "Gold_Challenge_Coin.3mf",
    "colors": [
...
<model unit="millimeter" xml:lang="en-US" xmlns="http://schemas.microsoft.com/3dmanufacturing/core/2015/02" xmlns:BambuStudio="http://schemas.bambulab.com/package/2021" xmlns:p="http://schemas.microsoft.com/3dmanufacturing/production/2015/06" requiredextensions="p">
 ...
 <metadata name="BambuStudio:3mfVersion">1</metadata>
 <metadata name="Title">Chattahoochee Gold Challenge Coin</metadata>
 <resources>
...
<config>
  <object id="{assembly_id}">
    <metadata key="name" value="Chattahoochee Gold Challenge Coin"/>
...
def main():
    ...
    print("=== Packaging Chattahoochee Gold Challenge Coin ===")
    print()
    print(f"--- {COIN['name']} ---")
