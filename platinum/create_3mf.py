#!/usr/bin/env python3
"""
Package McCloud Bux Platinum Challenge Coin STLs into a Bambu Studio-native 3MF.
...
Matches the exact format Bambu Studio 02.05.00.66 produces:
  ...
  - project_settings.config with correct platinum coin filament colors
...
COLORS = [
    ...
    {"name": "Brown",      "hex": "#A07A56", "stl": "coin_brown", "extruder": 2},
    {"name": "Light Gray", "hex": "#8F9694", "stl": "coin_gray",  "extruder": 3},
    {"name": "White",      "hex": "#FFFFFF", "stl": "coin_white", "extruder": 4},
]

OUTPUT_FILENAME = "McCloud_Bux_Platinum.3mf"
...
<model unit="millimeter" xml:lang="en-US" xmlns="http://schemas.microsoft.com/3dmanufacturing/core/2015/02" xmlns:BambuStudio="http://schemas.bambulab.com/package/2021" xmlns:p="http://schemas.microsoft.com/3dmanufacturing/production/2015/06" requiredextensions="p">
 ...
 <metadata name="BambuStudio:3mfVersion">1</metadata>
 <metadata name="Title">McCloud Bux Platinum Challenge Coin</metadata>
 <resources>
...
<config>
  <object id="{assembly_id}">
    <metadata key="name" value="McCloud Bux Platinum Challenge Coin"/>
...
def main():
    ...
    print("=== Packaging McCloud Bux Platinum Challenge Coin (4-Part Multi-Color) ===")
    print()

    print(f"--- {OUTPUT_FILENAME} ---")
    output = os.path.join(BUILD_DIR, OUTPUT_FILENAME)
    success = create_bambu_3mf(output, COLORS)
    if success:
