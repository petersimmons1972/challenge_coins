...
Verifies the Bambu Studio-native 3MF structure:
  ...
  - project_settings.config has correct McCloud Bux Platinum filament colors
"""
import json
import os
import sys
...
class TestExtruderAssignments(unittest.TestCase):
    ...
    def test_each_color_has_correct_extruder(self):
        ...
        self.assertEqual(assignments["Brown"], 2)
        self.assertEqual(assignments["Light Gray"], 3)
        self.assertEqual(assignments["White"], 4)


class TestFilamentColors(unittest.TestCase):
    """project_settings.config must have correct McCloud Bux Platinum colors."""
    ...
    def test_brown_is_slot_2(self):
        self.assertEqual(self.config["filament_colour"][1], "#A07A56")

    def test_gray_is_slot_3(self):
        self.assertEqual(self.config["filament_colour"][2], "#8F9694")
